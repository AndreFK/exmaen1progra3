...
    int habitantes = (*pais).habitantes;
    string nombre= (*pais).nombre;
    int superficie=(*pais).superficie;

        ofstream  in(nombre_archivo.c_str());
        in<<capital<<endl;
        in<<habitantes<<endl;
        in<<nombre<<endl;
        in<<superficie<<endl;
...
    Pais* pais=new Pais(nombre,capital,habitantes,superficie);
